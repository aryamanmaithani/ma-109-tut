...
\begin{frame}{Week 3}
    ...
    \begin{defn}[Inflection point]
        ...
        \begin{enumerate}
            \uncover<5->{\item $f$ is convex on $(c - \delta, c)$ and concave on $(c, c + \delta),$ {\color{red}or} }
            \uncover<6->{\item $f$ is concave on $(c - \delta, c)$ and convex on $(c, c + \delta).$ }
        \end{enumerate}
    \end{defn}
